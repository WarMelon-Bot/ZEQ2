export G_GetMuzzleSettings
code
proc G_GetMuzzleSettings 0 0
ADDRFP4 0
INDIRP4
ADDRGP4 muzzle
INDIRB
...
ASGNB 12
LABELV $63
endproc G_GetMuzzleSettings 0 0
